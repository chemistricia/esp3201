...
class ScriptArgs:
    ...
    file_path: str = "connections_prompts_copy.jsonl"
    max_retries: int = 10
    max_tokens: int = 128
...
# Add the dataclass as arguments to the parser
parser.add_arguments(ScriptArgs, dest="args")

# Parse the arguments (provide an empty list if no CLI args)
args = parser.parse_args([]).args

# Now 'args' will have default values from the ScriptArgs dataclass
print(args)
